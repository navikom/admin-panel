...
import { SIDEBAR_APPLICATION, SIDEBAR_MAIN, SIDEBAR_OTHER, SIDEBAR_USER } from "models/Constants";
...
const Links = ({...props}) => {
  ...
  const treeMap = [SIDEBAR_MAIN, SIDEBAR_APPLICATION, SIDEBAR_USER, SIDEBAR_OTHER]
    .map((key) =>
      [getKey(key), props.routes.filter((route: google.maps.DirectionsRoute & IRoute) => route.category === key)]);
